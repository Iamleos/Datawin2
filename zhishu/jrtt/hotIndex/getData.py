...
class xl():
        def pc(self,name,cookie,url):
            ...
            'Referer': 'https://index.toutiao.com/keyword/trends?keywords%5B%5D='+url_name,
            'Cookie': cookie,
...
url = 'https://index.toutiao.com/api/keyword/trends?region=0&category=0&keyword='+urllib.quote(name)+'&start='+last_date+'&end='+now_date+'&is_hourly=0'
#print url
