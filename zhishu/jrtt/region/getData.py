...
class xl():
        def pc(self,name,cookie,url,date):
            ...
            'Referer': 'https://index.toutiao.com/keyword/profile?keywords%5B%5D='+url_name+'&date='+date+'&span=1',
            'Cookie': cookie,
...
url = 'https://index.toutiao.com/api/keyword/regions?region=0&category=0&start='+last_date+'&end='+last_date+'&keyword='+urllib.quote(name)
#print url
print x.pc(name,cookie,url,date)
