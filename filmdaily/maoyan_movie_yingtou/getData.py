...
class xl():
        def pc(self,cookie,filmId,date,url):
            headers={
            ...
            'Referer': 'http://piaofang.maoyan.com/movie/'+filmId+'/shadowBox?date='+date,
            'Cookie': cookie,
...
url = 'http://piaofang.maoyan.com/movie/'+filmId+'/shadowBoxContent?date='+date
#print url
print x.pc(cookie,filmId,date,url)
