...
class xl():
        def pc(self,cookie,url):
            ...
            'Referer': 'http://piaofang.maoyan.com/company/cinema',
            'Cookie': cookie,
...
url = 'http://piaofang.maoyan.com/company/cinema?typeId=0&date='+date+'&webCityId=0&cityTier=0&page='+pageNum+'&noSum=1&cityName=%E5%85%A8%E5%9B%BD'
#print url
